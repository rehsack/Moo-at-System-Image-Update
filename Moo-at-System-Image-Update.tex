...
\uncover<4->{\item \rnode{c}{prevent} automatism starts when recent update is found}
\end{itemize}
\uncover<2>{\nccurve[linecolor=olive]{->}{a}{A}}
...
\uncover<4->{\item Provide \rnode{c}{authentication} to update server for development boxes (avoid \texttt{builder} is called)}
\end{itemize}
